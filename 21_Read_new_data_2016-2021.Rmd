...
write.csv(df_chem2a, "Input_data/Data_2016-2021_biota.csv", row.names = FALSE, quote = FALSE)  

write.csv(df_sed_values, "Input_data/Data_2016-2021_sediment.csv", row.names = FALSE, quote = FALSE)  
