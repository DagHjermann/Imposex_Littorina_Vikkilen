...
Figures in MS:
* 6A (map) edited based on map from 3b - "bathymetry with sample positions"
* 6B (graph) 7 (statistics) - "In same format as rest"  
...
### Overlapping data deom script 05?  
```{r}
...
### Bathymetry with sample positions    
```{r}
...
gg <- dat2 %>%
  ...
  geom_smooth(method = "lm") +
  scale_y_log10() +
  labs(y = "TBT (μg/kg w.w.)", x = "")

ggsave("Figures/07_tbt_vs_year.png", gg, 
